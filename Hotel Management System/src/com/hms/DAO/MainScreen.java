...
import com.hms.DAO.AvailablityOfRooms;
...
public class MainScreen {
	...
	private void initialize() {
		...
		btnCheckRooms.setIcon(new ImageIcon("D:\\Ecllipse_Work_Space\\workspace\\Hotel Management System\\images\\zoom-in.png"));
		btnCheckRooms.setBounds(0, 0, 136, 23);
		frame.getContentPane().add(btnCheckRooms);
